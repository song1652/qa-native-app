"""
tc_settings_location.py — Android | 설정 > Location 진입 확인
자동 생성: Capture Studio (2026-09-16 11:10)
"""
...
class TestTcSettingsLocation:
    """Capture Studio — 설정 > Location 진입 확인"""
    ...
    def test_tc_settings_location(self):
        """단계별 동작 및 검증"""
        # Step 1: el_1
